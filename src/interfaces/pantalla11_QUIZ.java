 ...
 * @author Gabriela Es
 */
public class pantalla11_QUIZ extends javax.swing.JFrame {

    private funcionBotones funcionBotones = new funcionBotones();

    public pantalla11_QUIZ() {
        initComponents();
        transparenceButton();
    ...
    private void initComponents() {
        ...
        title2.setText("QUIZ");
        jPanel1.add(title2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 90, -1, -1));
    ...
    private void tema8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tema8ActionPerformed
        // TODO add your handling code here:
        pantalla11_QUIZ panel10 = new pantalla11_QUIZ();
        funcionBotones.botonContinuar(panel10);
        this.dispose();
